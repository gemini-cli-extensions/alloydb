...
- **Authentication:** Ensure `gcloud auth application-default login` has been run.
- **Connectivity:** For private IP instances, the agent must run within the same VPC.
- **Permissions:** Verify the IAM roles mentioned in [Prerequisites](#prerequisites).
